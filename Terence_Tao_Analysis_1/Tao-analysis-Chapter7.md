...
* $\sum_{j = 0}^k \frac{k!}{j!(k - j)!}x^jy^{k - j + 1} = \sum_{j = 0}^k \frac{(k + 1)!}{j!(k + 1 - j)!}x^jy^{k + 1- j}\frac{k + 1 - j}{k + 1} = \sum_{j = 0}^{k + 1} \frac{(k + 1)!}{j!(k + 1 - j)!}x^jy^{k + 1- j}\frac{k + 1 - j}{k + 1}$ since when $j = k + 1$ the $\frac{(k + 1)!}{j!(k + 1 - j)!}x^jy^{k + 1- j}\frac{k + 1 - j}{k + 1} = 0$.  
