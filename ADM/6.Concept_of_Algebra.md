...
* Defintion 3  
Let $(A, *)$ be an algebraic system. Let $B$ be a subset of $A$. We say $B$ is closed under the operation $*$ if $x * y \in B$ for all $x, y \in B$.  
* Definition 4  
...
* Definition 4  
The ring $(R, +, *)$ is a field if $(R, +, *)$ is an integral domain and $(R - \{0\}, +, *)$ is an abelian group.  
