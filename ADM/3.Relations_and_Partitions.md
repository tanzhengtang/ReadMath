...
$a$ is a least upper bound for $B$ if $b R a$ for every $b \in B$. if (i) $a$ is an upper bound for $B$ and (ii) $a R x$ for every upper bound $x$ for $B$.  
$a$ is a greast upper bound for $B$ if $b R a$ for every $b \in B$. if (i) $a$ is an upper bound for $B$ and (ii) $a R x$ for every upper bound $x$ for $B$.  